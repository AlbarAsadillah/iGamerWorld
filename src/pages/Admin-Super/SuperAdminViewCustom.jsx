...
import SuperAdminSideNav from '../../components/SuperAdminSideNav'; // Sidebar SuperAdmin
import { useNavigate, useParams } from 'react-router-dom';

// Dummy data sama seperti AdminViewCustom
                        ...
                        >
                            ...
                            <Row>
                                <Col xs={24} style={{ textAlign: 'left', marginTop: 24 }}>
                                    <Button
                                        onClick={() => navigate('/superadmin-custom-pc')}
                                        style={{
...
export default SuperAdminViewCustom;
